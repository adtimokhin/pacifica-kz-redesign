...
const data = [
  ...
  },
  {
    ...
    subtitleOne: "0,5-1,0%",
    descriptionOne: "Снизилась вероятность КАТ-атаки в ходе работы с PACIFICA.KZ. А это очень хорошо! Вот такие мы молодцы",
    subtitleTwo: "+5,000 точек",
    descriptionTwo: "Было проверено за 3 месяца работы. Проверка на безопасность от USB-вандализма была пройдена",
  },
  {
    title: "Halyk Bank",
    subtitleOne: "800 млн ₸",
    descriptionOne: "Было обезопасено от воровства при помощи внедрения в Halyk Bank системы безопасности НСБК",
    subtitleTwo: "4,000 глаз",
    descriptionTwo: "Прошли наш курс по безопасности рабочего места. Теперь они не забывают выключать компьютеры!",
  },
];
